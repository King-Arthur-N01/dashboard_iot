    ...
    c.extend(g.prototype, {
        ...
        _draw: function () {
            ...
            for (var g = 0, f = c.length; g < f; g++) {
                ...
                this.c.startRender &&
                    ((d = this.c.startRender.call(this, b.rows(i), m)),
                    (d = this._rowWrap(d, this.c.startClassName)) &&
                        d.insertBefore(l.node()));
                this.c.endRender &&
                    ((d = this.c.endRender.call(this, b.rows(i), m)),
                    (d = this._rowWrap(d, this.c.endClassName)) &&
                        d.insertAfter(b.row(i[i.length - 1]).node()));
            }
        },
